...
const Environment: React.FC = () => {
  return (
    <div className="min-h-screen bg-warm-50">
      ...
      <div className="relative bg-gradient-to-br from-warm-100 via-coral-50 to-gold-50 py-20 md:py-32 overflow-hidden">
          ...
          <div className="text-center">
            <div className="mb-6">
              <span className="inline-block px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full text-sm font-medium text-warm-700 shadow-lg">
                🚀 Next-Generation Benchmark Platform
              </span>
            </div>
            <h1
            ...
            >
              Interactive AI-Generated
              <br />
              Environments
            </h1>
            <p className="text-lg md:text-xl text-gray-700 max-w-4xl mx-auto mb-8 leading-relaxed">
              Experience dynamic GUI testing environments generated by AI,
              providing unique and fair evaluation scenarios for every agent
              test. Explore our comprehensive test cases that demonstrate the
              challenges agents face in these environments.
            </p>
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-lg leading-relaxed mb-4">
                      Our advanced AI creates completely unique interfaces,
                      layouts, and interaction patterns for each evaluation
                      session. Every test generates fresh environments that
                      prevent memorization and ensure genuine problem-solving
                      assessment.
                    </p>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Live testing scenarios where agents can click, type,
                    navigate, and manipulate interface elements with immediate
                    feedback.
                  </p>
                </div>
              </div>
            ...
            <div className="card shadow-lg p-6 bg-white hover:shadow-xl transition-all duration-300 group">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Environments adapt in complexity based on agent capabilities
                    and evaluation requirements for fair assessment.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="card shadow-lg p-6 bg-gradient-to-br from-gray-50 to-white hover:shadow-xl transition-all duration-300">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Complex scenarios requiring agents to complete sequences of
                    actions to achieve goals with state preservation.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="card shadow-lg p-6 bg-gradient-to-br from-gray-50 to-white hover:shadow-xl transition-all duration-300">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Comprehensive state tracking and persistence for complex
                    multi-step workflows with memory preservation.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-warm-500 to-coral-500 rounded-3xl p-8 md:p-12 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button className="btn-primary-on-warm shadow-xl">
                    Get Started Today
                  </button>
                  <button className="btn-secondary-on-warm">
                    View Documentation
                  </button>
                </div>
              </div>
